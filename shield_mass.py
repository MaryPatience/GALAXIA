...
final = CM_shield(141.42, 0.2, 0.03) + CM_to_detector_shield(0.2,100,141.42,500) + detector_shield(100, 0.7, 0.2,100, 100, 0.7)
mass_of_shield = (detector_shield(100, 0.7, 0.2,100, 100, 0.7)*(11.4+7.28+8.92)) + (CM_shield(141.42, 0.2, 0.03) + CM_to_detector_shield(0.2,100,141.42,500)*(7.28+8.92))
